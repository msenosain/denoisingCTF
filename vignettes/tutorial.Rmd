...
knitr::opts_knit$set(root.dir = "../inst/doc/example")
```
...
dead cells. Here, we used Fluidigm recommendations and our marker for 
intact cells:
...
__2. Model training__
This is exactly the same as for the beads model training but changing some labels:
```{r, eval = FALSE}
